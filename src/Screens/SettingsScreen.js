...
import { Card, Divider } from "react-native-paper"; // Importing Paper components
        ...
        <Animatable.View animation="fadeInUp" style={styles.section}>
          <Card style={styles.card}>
            ...
            >
              ...
              <Text style={[styles.optionText, { color: "#333" }]}>Change Password</Text>
            </TouchableOpacity>
          </Card>
        </Animatable.View>
        ...
        <Animatable.View animation="fadeInUp" style={styles.section}>
          <Card style={styles.card}>
            <TouchableOpacity style={styles.option}>
              ...
              <Text style={[styles.optionText, { color: "#FF6347" }]}>Log Out</Text>
            </TouchableOpacity>
          </Card>
        </Animatable.View>
      </ScrollView>
